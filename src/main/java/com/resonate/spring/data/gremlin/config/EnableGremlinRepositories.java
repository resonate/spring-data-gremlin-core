package com.resonate.spring.data.gremlin.config;
...
/**
 * Annotation to enable Gremlin repositories. Will scan the package of the annotated configuration class for Spring Data
...
public @interface EnableGremlinRepositories {
     ...
     * {@code @EnableGremlinRepositories("org.my.pkg")} instead of {@code @EnableGremlinRepositories(basePackages="org.my.pkg")}.
     */
